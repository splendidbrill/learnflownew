              ...
              <div className="hidden md:block">
                {loading ? (
                  ...
                  <motion.button
                    ...
                    className="bg-gradient-to-br from-white/10 to-white/5 text-white border border-white/20 backdrop-blur-xl px-6 py-2.5 rounded-lg"
                  >
                    Sign In
                  </motion.button>
                )}
                    ...
                    <div className="pt-2">
                      {loading ? (
                        ...
                        <div className="space-y-2">
                          ...
                          <button
                            onClick={() => router.push("/dashboard")}
                            className="w-full bg-gradient-to-br from-white/10 to-white/5 text-white border border-white/20 backdrop-blur-xl px-4 py-2.5 rounded-lg flex items-center justify-center gap-2"
                          >
                            <LayoutDashboard className="w-4 h-4" />
                            Dashboard
                          </button>
                          ...
                          <button
                            onClick={handleSignOut}
                            className="w-full bg-red-500/10 text-red-400 border border-red-500/20 px-4 py-2.5 rounded-lg flex items-center justify-center gap-2"
                          >
                            <LogOut className="w-4 h-4" />
                            Logout
                          </button>
                        ...
                        <button
                          ...
                          className="w-full bg-gradient-to-br from-white/10 to-white/5 text-white border border-white/20 backdrop-blur-xl px-6 py-2.5 rounded-lg"
                        >
                          Sign In
                        </button>
                      )}
            ...
            >
              <div className="bg-gradient-to-br from-slate-900 to-slate-950 border border-white/20 rounded-2xl shadow-2xl w-full max-w-md p-8 relative">
                ...
                <button
                  ...
                  className="w-full bg-white hover:bg-gray-100 text-gray-900 font-semibold py-4 px-6 rounded-xl flex items-center justify-center gap-3 shadow-lg"
                >
                  {/* Google Logo */}
